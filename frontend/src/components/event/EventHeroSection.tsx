      ...
      <section className="relative w-full h-72 md:h-[500px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full p-6 md:p-10 max-w-6xl mx-auto inset-x-0">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-white leading-tight mb-4 tracking-tight drop-shadow-lg">
            <EditableField value={event.title} fieldName="title" eventId={event.id} canEdit={editMode} onSaved={fetchEvent} className="text-3xl md:text-5xl font-bold text-white leading-tight tracking-tight" inputClassName="text-xl font-bold" />
          </h1>
          <HeroMeta event={event} iconColor="text-emerald-300" textColor="text-white/80" />
        </div>
      </section>
    );
  }
    ...
    <section className="relative w-full overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 pt-2 pb-6">
        ...
        <h1 className="text-3xl md:text-5xl font-bold text-slate-800 leading-tight mb-4 tracking-tight">
          <EditableField value={event.title} fieldName="title" eventId={event.id} canEdit={editMode} onSaved={fetchEvent} className="text-3xl md:text-5xl font-bold text-slate-800 leading-tight tracking-tight" inputClassName="text-xl font-bold" />
        </h1>
        <HeroMeta event={event} iconColor="text-[#1a4f3b]" textColor="text-slate-500" />
...
function HeroMeta({ event, iconColor, textColor }: HeroMetaProps) {
  return (
    <div className={`flex flex-wrap items-center gap-5 ${textColor} text-sm font-medium`}>
