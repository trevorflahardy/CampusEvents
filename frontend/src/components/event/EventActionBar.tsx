        ...
        <div className="shrink-0 flex items-center gap-3">
          ...
          {!canBook &&
            ...
            (userRole === "admin" || userRole === "organizer") && (
              <span className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 bg-slate-100 dark:bg-slate-800 dark:text-slate-400 px-4 py-2.5 rounded-full">
                <svg
